    ...
    <div class="idocs-content">
        <div class="container">
            ...
            <section id="idocs_start">
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-4">
                        <ul class="list-unstyled">
                            ...
                            <li><strong>Author:</strong> <a href="http://www.harnishdesign.net" target="_blank">Harnish
                                    Design</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                ...
                <p class="alert alert-info">If you have any questions that are beyond the scope of this help file,
                    Please feel free to email via <a target="_blank"
            ...
            <section id="idocs_installation">
                ...
                <ol>
                    <li>Unzip the downloaded package and open the <strong>/HTML</strong> folder to find all the
                        template files. You will need to upload these files to your hosting web server using FTP or
                        localhost in order to use it on your website.
                    </li>
...
&lt;/html&gt;</code></pre>
                <p class="alert alert-info">If you need more information, please visit bootstrap site: <a
                        target="_blank"
                        href="https://getbootstrap.com/docs/4.4/layout/grid/">https://getbootstrap.com</a>
                </p>
            </section>
            ...
            <section id="idocs_sass">
                ...
                <p>Open the <code>sass/_variables.scss</code> and Edit the values according to your needs. If you
                    need more Advanced Setup then you can Edit the Respective Files yourself which have been
                    branched inside the same Folder. It is completely at your discretion only to include the
                    Required <code>.scss</code> Files you need to minimize the amount of CSS & including only the
                    Styles of the Blocks you need. This can be setup in your <code>stylesheet.scss</code> File.</p>
            </section>
            ...
            <section id="idocs_color_schemes">
                <h2>Color Schemes</h2>
                <p>You can change your Website's Color Scheme in an instant. We have build <strong>10 Color</strong>
                    css file for change template primary color.</p>
                <ul>
                ...
                <p>Simply add Color CSS file link it in the Document <code>&lt;head&gt;</code>.<br>
                    Make sure you add the <code>css/color-blue.css</code> stylesheet in your head after the <code>css/stylesheet.css</code>
                    file linking from above mentioned 10 color css file.</p>
...
&lt;/head&gt;</code></pre>
            ...
            <section id="idocs_theme_customization">
                ...
                <p>We have include a Custom CSS File in the <code>css</code> Folder so that you can better handle
                    your Customizations for New Styles or
                    Overwriting Default Theme Styles. Simply add all your Custom CSS Codes in the
                    <code>css/custom.css</code>
                    File and link it in the Document <code>&lt;head&gt;</code> after the
                    <code>css/stylesheet.css</code> Linking. Also make sure that this is the Last Linked CSS File in
                    the Document <code>&lt;head&gt;</code> so that your Custom CSS Styles are Overwritten properly.
                </p>
                <pre><code class="html">&lt;head&gt;
&lt;!-- Stylesheet
============================== --&gt;
...
&lt;!-- Logo End --&gt;
            ...
            <section id="idocs_header">
                ...
                <h4>Light</h4>
                <p>Header with white background Color & Dark text. <span class="text-info">See below image and code for more inforamtion.</span>
                </p>
                <p><a class="popup-img" href="{{ asset('template/images/header-light.jpg') }}"><img
                            class="img-fluid border"
                            src="{{ asset('template/images/header-light.jpg') }}"
                            alt=""></a></p>
...
&lt;!-- Header End --&gt;
                ...
                <h4>Dark</h4>
                <p>Header with dark background & Light text. <span class="text-info">See below image and code for more inforamtion.</span>
                </p>
                <p><a class="popup-img" href="{{ asset('template/images/header-dark.jpg') }}"><img
                            class="img-fluid border"
                            src="{{ asset('template/images/header-dark.jpg') }}"
                            alt=""></a></p>
...
&lt;!-- Header End --&gt;
            ...
            <section id="idocs_navbar">
                ...
                <p>Header with Navigation alligned Left. <span class="text-info">See below image and code for more inforamtion.</span>
                </p>
                <p><a class="popup-img" href="{{ asset('template/images/navbar-left.jpg') }}"><img
                            class="img-fluid border"
                            src="{{ asset('template/images/navbar-left.jpg') }}"
                            alt=""></a></p>
                <p>Add the <code>.justify-content-left</code> class to the element of collapse to display a align
                    left navbar.</p>
...
&lt;/div&gt;
                ...
                <p>Header with Navigation alligned Right. <span class="text-info">See below image and code for more inforamtion.</span>
                </p>
                <p><a class="popup-img" href="{{ asset('template/images/navbar-right.jpg') }}"><img
                            class="img-fluid border"
                            src="{{ asset('template/images/navbar-left.jpg') }}"
                            alt=""></a></p>
...
&lt;/div&gt;
                ...
                <p>Header with Navigation alligned Center. <span class="text-info">See below image and code for more inforamtion.</span>
                </p>
                <p><img class="img-fluid border" src="{{ asset('template/images/navbar-center.jpg') }}"
                        alt=""></p>
                <p>Add the <code>.justify-content-center</code> class to the element of collapse to display a align
                    center navbar.</p>
...
&lt;/div&gt;
            ...
            <section id="idocs_sidebar">
                ...
                <p class="lead">We have built fixed sidebar navigation with <a target="_blank"
                                                                               href="https://getbootstrap.com/docs/4.4/components/scrollspy/">bootstrap
                        scrollspy</a> function for docs layout. which is automatically update navigation based on
                    scroll position to indicate which link is currently active in the viewport.</p>
                <p>The example below sidebar vertical navigation with bootstrap <a target="_blank"
                                                                                   href="https://getbootstrap.com/docs/4.4/components/navs/">navs</a>
                    and <a target="_blank"
...
&lt;/div&gt;
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <p><a class="popup-img" href="{{ asset('template/images/sidebar-light.jpg') }}"><img
                                    class="img-fluid border"
                                    src="{{ asset('template/images/sidebar-light.jpg') }}"
                                    alt=""></a></p>
                    </div>
                </div>
...
&lt;/div&gt;</code></pre>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <p><a class="popup-img" href="{{ asset('template/images/sidebar-dark.jpg') }}"><img
                                    class="img-fluid border"
                                    src="{{ asset('template/images/sidebar-dark.jpg') }}"
                                    alt=""></a></p>
                    </div>
                </div>

                <p>Add the <code>.bg-dark</code> and <code>.docs-navigation-dark</code> class to the main sidebar
                    navigation div element to display a dark sidebar.</p>
                <pre><code>&lt;!-- Sidebar Navigation
============================ --&gt;
...
&lt;!-- Footer end --&gt;</code></pre>
            ...
            <section id="idocs_content">
                <h2>Content</h2>
                <p class="lead mb-5">Documentation and examples for displaying typography, code, table, image and
                    video and more..</p>
            </section>
            ...
            <section id="idocs_typography">
                ...
                <p class="lead">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Anim
                    pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid.</p>
...
&lt;p&gt;&lt;em&gt;This line rendered as italicized text.&lt;/em&gt;&lt;/p&gt;
            ...
            <section id="idocs_code">
                ...
                <p>Use <code>&lt;pre&gt;</code>s for multiple lines of code. <span class="text-info">Once again, be sure to escape any angle brackets in the code for proper rendering</span>.
                    You may optionally add the <code>.pre-scrollable</code> class, which will set a max-height of
...
&lt;/pre&gt;&lt;/code&gt;
                ...
                <p>We use <strong><a target="_blank" href="https://highlightjs.org/">Highlight Js</a></strong> for
                    syntax highlight code snippet.</p>
                <p>You can refer more information here: <a class="btn btn-primary" target="_blank"
                                                           href="https://highlightjs.org/usage/"><i
            ...
            <section id="idocs_table">
                ...
                <p>iDocs is based on Bootstrap 4, so you can easily use Bootstrap's table classes to style your
                    table. <a class="ml-1" target="_blank" href="https://getbootstrap.com/docs/4.4/content/tables/"><i
...
&lt;i class=&quot;fab fa-facebook-f&quot;&gt;&lt;/i&gt;
                ...
                <p><span class="badge badge-danger text-uppercase mr-2">Note</span>Please go to their official
                    documentation pages for a full list of icons: <a class="btn btn-primary" target="_blank"
                                                                     href="https://fontawesome.com/icons"><i
                            class="fas fa-external-link-alt mr-1"></i> Font Awesome</a></p>
            </section>
            ...
            <section id="idocs_image">
                ...
                <p><img src="{{ asset('template/images/screenshot.jpg') }}" class="img-fluid"
                ...
                <p><a class="popup-img" href="{{ asset('template/images/screenshot.jpg') }}"><img
                            src="{{ asset('template/images/screenshot-thumb.jpg') }}"
...
&lt;/a&gt;</code></pre>
                ...
                <p>Show image popup when click on link: <a class="popup-img"
                                                           href="{{ asset('template/images/screenshot.jpg') }}">Click
                        Here for Popup Image</a></p>
            ...
            <section id="idocs_video">
                ...
                <p>Wrap any embed like an <code>&lt;iframe&gt;</code> in a parent element with
                    <code>.embed-responsive</code>
                    and an aspect ratio. The <code>.embed-responsive-item</code> isn’t strictly required, but we
                    encourage it.</p>
...
&lt;/div&gt;</code></pre>
            ...
            <section id="idocs_accordion">
                ...
                <p><a class="popup-img" href="{{ asset('template/images/accordion.jpg') }}"><img
                            class="img-fluid border"
                            src="{{ asset('template/images/accordion.jpg') }}"
                            alt=""></a></p>
...
&lt;/div&gt;</code></pre>
            ...
            <section id="idocs_tabs">
                ...
                <p>See below image and code for more inforamtion.</p>
                <p><a class="popup-img" href="{{ asset('template/images/tabs.jpg') }}"><img
                            class="img-fluid border"
                            src="{{ asset('template/images/tabs.jpg') }}" alt=""></a>
                </p>
...
&lt;/ul&gt;</code></pre>
            ...
            <section id="idocs_helper_classes">
                ...
                <p>We have created some really useful helper classes for you. Here are a few of them. also, You can
                    refer other default bootstrap helper classes here: <a class="ml-1" target="_blank"
                ...
                <ul>
                    ...
                    <li><code>.shadow-md</code> - For medium light shadows to elements with box-shadow utilities.
                    </li>
            ...
            <section id="idocs_faq">
                <h2>FAQ</h2>
                <p class="text-4">A FAQ is a list of frequently asked questions (FAQs) and answers on a particular
                    topic.</p>
                            ...
                            <div class="card">
                                <div class="card-header" id="heading1">
                                    <h5 class="mb-0"><a href="#" class="collapsed" data-toggle="collapse"
                                                        ...
                                                        aria-controls="collapse1">What does royalty free mean?</a>
                                    </h5>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="heading2">
                                    <h5 class="mb-0"><a href="#" class="collapsed" data-toggle="collapse"
                                                        ...
                                                        aria-controls="collapse2">What is a single application?</a>
                                    </h5>
                                </div>
                                <div id="collapse2" class="collapse" aria-labelledby="heading2"
                                     data-parent="#popularTopics">
                                    <div class="card-body"> Iisque Anim pariatur cliche reprehenderit, enim eiusmod
                                        high life accusamus terry richardson ad squid. Food truck quinoa nesciunt
                            ...
                            <div class="card">
                                <div class="card-header" id="heading3">
                                    <h5 class="mb-0"><a href="#" class="collapsed" data-toggle="collapse"
                                                        ...
                                                        aria-controls="collapse3">What are some examples of
                                            permitted end products?</a></h5>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="heading4">
                                    <h5 class="mb-0"><a href="#" class="collapsed" data-toggle="collapse"
                                                        ...
                                                        aria-controls="collapse4">I'm not sure if my use is covered.
                                            What should I do?</a></h5>
                                </div>
                                <div id="collapse4" class="collapse" aria-labelledby="heading4"
                                     data-parent="#popularTopics">
                                    <div class="card-body"> Lorem Ipsum is simply dummy text of the printing and
                                        typesetting industry. Anim pariatur cliche reprehenderit, enim eiusmod high
                            ...
                            <div class="card">
                                <div class="card-header" id="heading5">
                                    <h5 class="mb-0"><a href="#" class="collapsed" data-toggle="collapse"
                                                        ...
                                                        aria-controls="collapse5">What is a single application?</a>
                                    </h5>
                                </div>
                                <div id="collapse5" class="collapse" aria-labelledby="heading5"
                                     data-parent="#popularTopics">
                                    <div class="card-body"> Lorem Ipsum is simply dummy text of the printing and
                                        typesetting industry. Food truck quinoa nesciunt laborum eiusmod. Brunch 3
                            ...
                            <div class="card">
                                <div class="card-header" id="heading6">
                                    <h5 class="mb-0"><a href="#" class="collapsed" data-toggle="collapse"
                                                        ...
                                                        aria-controls="collapse6">Am I allowed to modify the item
                                            that I purchased?</a></h5>
                                </div>
            ...
            <section id="idocs_source_credits">
                ...
                <ul>
                    ...
                    <li>Magnific Popup - <a target="_blank" href="http://dimsemenov.com/plugins/magnific-popup/">http://dimsemenov.com/plugins/magnific-popup/</a>
                    </li>
                </ul>
            </section>
            ...
            <section id="idocs_support">
                ...
                <p> We are located in GMT +5:30 time zone and we answer all questions within 12-24 hours in
                    weekdays. In some rare cases the waiting time can be to 48 hours. (except holiday seasons which
                    might take longer).</p>
                <div class="alert alert-warning mb-4"><span class="badge badge-danger text-uppercase">Note:</span>
                ...
                <div class="alert alert-success">
                    ...
                    Go to your <strong>Themeforest Profile</strong> > <strong>Downloads Tab</strong> > & then You
                    can Rate & Review for our template.<br>
                    Thank You.
                </div>
            </section>
                ...
                <div class="row">
                    <div class="col-4 my-3 text-center">
                        <a target="_blank" href="https://themeforest.net/item/x/28476751?ref=HarnishDesign"><img
                                class="img-fluid border"
                                src="{{ asset('template/images/templates/simone.jpg') }}" alt="">
                    ...
                    <div class="col-4 my-3 text-center">
                        <a target="_blank" href="https://themeforest.net/item/x/26454458?ref=HarnishDesign"><img
                                class="img-fluid border"
                                src="{{ asset('template/images/templates/kenil.jpg') }}" alt="">
                    ...
                    <div class="col-4 my-3 text-center">
                        <a target="_blank" href="https://themeforest.net/item/x/26313677?ref=HarnishDesign"><img
                                class="img-fluid border"
                                src="{{ asset('template/images/templates/doon.jpg') }}" alt="">
                    ...
                    <div class="col-4 my-3 text-center">
                        <a target="_blank" href="https://themeforest.net/item/x/27172933?ref=HarnishDesign"><img
                                class="img-fluid border"
                                src="{{ asset('template/images/templates/domainx.jpg') }}" alt="">
                    ...
                    <div class="col-4 my-3 text-center">
                        <a target="_blank" href="https://themeforest.net/item/x/28848609?ref=HarnishDesign"><img
                                class="img-fluid border"
                                src="{{ asset('template/images/templates/oxyy.jpg') }}" alt="">
                    ...
                    <div class="col-4 my-3 text-center">
                        <a target="_blank" href="https://themeforest.net/item/x/27034971?ref=HarnishDesign"><img
                                class="img-fluid border"
                                src="{{ asset('template/images/templates/koice.jpg') }}" alt="">
                    ...
                    <div class="col-4 my-3 text-center">
                        <a target="_blank" href="https://themeforest.net/item/x/24017808?ref=HarnishDesign"><img
                                class="img-fluid border"
                                src="{{ asset('template/images/templates/payyed.jpg') }}" alt="">
                    ...
                    <div class="col-4 my-3 text-center">
                        <a target="_blank" href="https://themeforest.net/item/x/22375065?ref=HarnishDesign"><img
                                class="img-fluid border"
                                src="{{ asset('template/images/templates/quickai.jpg') }}" alt="">
            ...
            <section id="idocs_changelog">
                ...
                <p class="alert alert-info mb-5"> For Future Updates Follow Us <a target="_blank"
                    ...
                    / <a target="_blank" href="http://facebook.com/harnishdesign">@facebook</a> / <a target="_blank"
                                                                                                     href="http://twitter.com/harnishdesign">@twitter</a>
                ...
                <ul class="changelog">
                    <li><span class="badge badge-success">Added</span> Your information here for added new feature
                    </li>
